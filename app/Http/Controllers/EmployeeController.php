...
class EmployeeController extends Controller
{
    ...
    {
        $inputUser=$request->only('user_roles_id', 'employee_firstname', 'employee_middlename','employee_lastname','employee_username','employee_password','employee_email','employee_status','employee_image');
        ...
        $options = [
            ...
            'json' => $request-> $inputUser
        ];
        $responseService = $client->request('POST', env('GATEWAY') . '/Employee', $options);
